...
from Mentors.Mentors import settings
from .models import Course, Program, User, Upload, Student, New, Grade, afatet_provimeve, Provimet
from django.contrib.auth.models import User, Group
#from elearning import settings
from django.db.models import Sum, Avg, Max, Min, Count
from .forms import UploadFormFile, UpdateProfile, SelectTeachersForm, AddPostForm, GradeStudentsForm, CourseAddForm, \
    ProgramForm, AfatetForm
...
def course_detail(request, pk):
    ...
    if request.user.is_authenticated:
        return render(
            ...
            {'usrs': users, 'course': course, 'files': files, 'grades': grades, 'teachers': teachers,
